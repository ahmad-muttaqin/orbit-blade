							...
							<div class="profile-pic m-3">
								...
								<ul class="nav nav-tabs mb-3 flex d-block" id="ex-with-icons" role="tablist">
									<li class="nav-item border mb-2 mt-2 rounded-2" role="presentation">
										<a class="nav-link" id="ex-with-icons-tab-3" data-mdb-toggle="tab" href="#ex-with-icons-tabs-3" role="tab" aria-controls="ex-with-icons-tabs-3" aria-selected="false"><i class="fas fa-user fa-fw me-2"></i>My Profile</a>
									</li>
									<li class="nav-item border mb-2 mt-2 rounded-2" role="presentation">
										<a class="nav-link" id="ex-with-icons-tab-3" data-mdb-toggle="tab" href="#ex-with-icons-tabs-3" role="tab" aria-controls="ex-with-icons-tabs-3" aria-selected="false"><i class="fas fa-file-lines fa-fw me-2"></i>Employment Details</a>
									</li>
									<li class="nav-item border mb-2 mt-2 rounded-2" role="presentation">
										<a class="nav-link" id="ex-with-icons-tab-3" data-mdb-toggle="tab" href="#ex-with-icons-tabs-3" role="tab" aria-controls="ex-with-icons-tabs-3" aria-selected="false"><i class="fas fa-cogs fa-fw me-2"></i>Change Password</a>
									</li>
									<li class="nav-item border mb-2 mt-2 rounded-2" role="presentation">
										<a class="nav-link" id="ex-with-icons-tab-3" data-mdb-toggle="tab" href="#ex-with-icons-tabs-3" role="tab" aria-controls="ex-with-icons-tabs-3" aria-selected="false"><i class="fas fa-car fa-fw me-2"></i>Vehicle Details</a>
									</li>
									<li class="nav-item border mb-2 mt-2 rounded-2" role="presentation">
										<a class="nav-link" id="ex-with-icons-tab-3" data-mdb-toggle="tab" href="#ex-with-icons-tabs-3" role="tab" aria-controls="ex-with-icons-tabs-3" aria-selected="false"><i class="fas fa-calendar fa-fw me-2"></i>eLeave</a>
									</li>
								</ul>
								<!-- Tabs navs -->
							</div>
