...
<body>
	...
	<!-- END breadcrumb -->
	<!-- BEGIN page-header -->
	<h1 class="page-header">Report | Claim Report </h1>
...
<div class="row mb-3" id="hideProject">
    <div class="col-md-4">
...
<div class="row mb-3" id="hideDepart">
    <div class="col-md-4">
...
<div class="row mb-3" id="hideEmpName">
    <div class="col-md-4">
...
<div class="row mb-3" id="hideRefNum">
    <div class="col-md-4">
