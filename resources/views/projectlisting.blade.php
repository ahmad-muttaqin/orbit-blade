...
<body>
	...
	<!-- BEGIN panel -->
        ...
        <div class="dropdown ms-auto mb-3 align-items-end">
            <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenu2" data-bs-toggle="dropdown" aria-expanded="false">
                <i class="fas fa-book fa-fw"></i>
            </button>
            <ul class="dropdown-menu" aria-labelledby="dropdownMenu2">
                <li><button class="dropdown-item" type="button"><i class="fas fa-file-pdf fa-fw"></i>Download</button></li>
                <li><button class="dropdown-item" type="button"><i class="fas fa-print fa-fw"></i>Print</button></li>
            </ul>
        </div>


    <div class="panel panel-inverse mt-auto">
        ...
        <div class="panel panel-inverse">
                <div class="panel-heading">
                    <h4 class="panel-title">Project Member List</h4>
                </div>
                <div class="panel-body">
