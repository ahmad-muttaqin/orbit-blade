...
<body>
	...
	<h1 class="page-header">Settings | Update Entitlement Group</h1>
        ...
        <!-- Modal subsistence -->
        <div class="modal fade" id="updatesubsistence" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <button type="button" id="savesubsistence" class="btn btn-primary">Update Changes</button>
                </div>
            </div>
            </div>
        </div>
...
{{-- modal claim --}}
  <div class="modal fade" id="updateclaimbenefit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
