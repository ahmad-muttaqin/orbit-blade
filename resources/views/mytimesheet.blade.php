...
<body>
	...
	<div id="app" class="app app-header-fixed app-sidebar-fixed">
		...
		<!-- START MODAL EDIT EVENT -->
				...
				<!-- SUMMARY TIMESHEET  -->
				<!-- <a href="/timesheet/mytimesheet" id=> -->
				<!-- <div class="modal fade" id="summarymodal" tabindex="-1" aria-labelledby="add-children" aria-hidden="true" href="/timesheet/mytimesheet">
					<a class="dropdown-item" href="/timesheet/mytimesheet">View Calendar</a> 
				</div>  -->
				<!-- END SUMMARY TIMESHEET -->
			</div>
		</div>
		<!-- START MODAL EDIT EVENT -->
  ...
  var d = new Date();
	...
	customButtons: {
		...
		SumButton: {
            ...
            click:function(event, jsEvent, view){
                   $('/timesheet/timesheet_summary').show();
          }
        },
	},
