							...
							<div class="card-body bg-white">
									...
									<form action="index.html" method="GET" class="fs-13px">
										...
										<div class="form-floating mb-15px">
											<input type="text" class="form-control h-45px fs-13px" placeholder="Email Address" id="tenancyName" />
											<label for="tenancyName" class="d-flex align-items-center fs-13px text-gray-600">Tenant Name</label>
										</div>
										<div class="form-floating mb-15px">
											<input type="text" class="form-control h-45px fs-13px" placeholder="Email Address" id="tenantName" />
